...
class TIPoint : public TPoint
	{
	public:
		// Constructors
		TIPoint() {}
		TIPoint( int _x, int _y ) : TPoint( _x, _y ) {}
		TIPoint( const POINT far& point ) : TPoint( point ) {}
		TIPoint( const TPoint far& point ) : TPoint( point ) {}
		TIPoint( const SIZE far& size ) : TPoint( size ) {}
		TIPoint( uint32 dw ) : TPoint( dw ) {}
...
class TISize : public TSize
	{
	public:
		// Constructors
		TISize() {}
		TISize( int dx, int dy ) : TSize( dx, dy ) {}
		TISize( const POINT far& point ) : TSize( point ) {}
		TISize( const SIZE far& size ) : TSize( size ) {}
		TISize( const TSize far& size ) : TSize( size ) {}
...
class TIRect : public TRect
	{
	public:
		// Constructors
		TIRect() {}
		TIRect( const RECT far& rect ) : TRect( rect ) {}
		TIRect( const TRect far& rect ) : TRect( rect ) {}
		TIRect( int _left, int _top, int _right, int _bottom ) : TRect( _left, _top, _right, _bottom ) {}
		TIRect( const TPoint& upLeft, const TPoint& loRight ) : TRect( upLeft, loRight ) {}
		TIRect( const TPoint& origin, const TSize& extent ) : TRect( origin, extent ) {}
